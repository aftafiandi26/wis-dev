...
@section('body')
    ...
    <div class="row">
        ...
        <div class="col-lg-6 pull-right">
            ...
            <a class="btn btn-sm page-header pull-right" style="color: green;" title="Leave Guide"
                href="https://drive.google.com/file/d/1cqhqETMRXBZB2aBCcZ8CCYtjjaXAldLr/view?usp=sharing" target="_blank"> <i
    ...
    <div class="row">
        <div class="col-lg-4">
                ...
                <table class="table table-striped table-hover table-condensed" id="tables">
                    ...
                    <tbody>
                        <tr style="white-space:nowrap">
                            ...
                            <td>
                                ...
                                @if ($totalAnnualPermanent1 > 0)
                                    <a href="{!! URL::route('leave/create') !!}" class="btn btn-primary btn-xs"
                                        role="button">Apply</a>
                                @endif
                        ...
                        <tr style="white-space:nowrap">
                            ...
                            <td>
                                @if ($remainExdo > 0)
                                    <a href="{!! URL::route('leave/createExdo') !!}" class="btn btn-primary btn-xs"
                                        role="button">Apply</a>
                                @endif
                            </td>
                            <td></td>
                        ...
                        <tr style="white-space:nowrap">
                            ...
                            <td>-</td>
                            <td>
                                <a href="{!! URL::route('leave/createEtc') !!}" class="btn btn-primary btn-xs" role="button">Apply</a>
                            </td>
            ...
            <p style="font-size: 11px;"><i>Note : Please check the balance of your leave, Should any dispute , please
                    contact the Receptionist </i></p>
        </div>
        <div class="col-lg-8">
            <h4>Index Annual</h4>
            <div class="table-responsive">
                ...
                <?php else: ?>
                <h4 style="color: red;">Index Forfeited (<sup style="color: grey;"><small>oops! sorry, forfeited leave is
                            non-refundable</small></sup>)</h4>
                <?php endif ?>

                <table class="table table-striped table-hover table-condensed" id="indexForfeited">
                    <thead>
                        <tr>
                            <th>Total Amount Forfeit <a href="{{ route('employee/forfeited/index') }}"
                                    class="btn btn-primary btn-xs">Check</a></th>
                        </tr>
                        <tr>
                            <th class="pull-left">
