...
@section('body')
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="request_by" name="request_by"
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="startLeaveDate" name="startLeaveDate"
                                    required>
                            </div>
                        </div>
                        <div class="col-lg-2">
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="period" value="{{ date('Y') }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-lg-2">
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="date" name="joindDate" class="form-control" id="joinDate"
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="dept" class="form-control" id="dept"
                                    value="{{ $data->dept_category_name }}" readonly>
                            </div>
                        </div>
                        <div class="col-lg-4"></div>
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="request_day" id="request_day" class="form-control"
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="endDate" id="endDate" class="form-control"
                                    value="@if ($data->end_date) {{ $data->end_date }} @else -- @endif"
                                    readonly>
                            </div>
                        </div>
                        @if ($data->nationality == 'Indonesia')
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <select name="destination" id="destination" class="form-control" required>
                                        ...
                                        <option value="{{ $nama_provinsi['id'] }}">
                                            {{ title_case($nama_provinsi['name']) }}</option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <select name="city" id="city" class="form-control" required="true"></select>
                                </div>
                            </div>
                        @else
                            <div class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required id="destinations"
                                        name="destination" placeholder="input country">
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="available" id="available" class="form-control"
                                    name="availableLeave" value="{{ $availableLeave }}" readonly>
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="available" id="available" class="form-control"
                                    name="advanceAnnual" value="{{ $advanceAnnual }}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <textarea name="reason" id="reason" cols="20" rows="5" class="form-control" maxlength="100"
                                    required></textarea>
                            </div>
                        </div>
                        <div class="col-lg-4"></div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="exdo" id="exdo" class="form-control" name="exdo"
                                    value="{{ $exdo }}" readonly>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="showModalTables" tabindex="-1" role="dialog" aria-labelledby="showModalLabel"
        aria-hidden="true">
...
@push('js')
    <script>
        ...
        $('#city').html('');
        var myElements = $("#destination").val(); <
        !--
        var situs = 'https://dev.farizdotid.com/api/daerahindonesia/kota?id_provinsi=' +
            destination + '';
        -- >
    ...
    `);
        ...
        $(document).on('click', 'table#tables tr td a[id="detail"]
        ',function(e) { var id=$(this).attr('
        data - role '); console.log(id); $.ajax({ url: id, success: function(e) {
