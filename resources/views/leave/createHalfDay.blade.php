        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-body">
                    {!! Form::open(['route' => 'leave/storeHalfDay', 'role' => 'form', 'autocomplete' => 'off']) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                 <?php if (auth::user()->hd === 1): ?> 
                                    <!-- HOD Rule -->
                                    <?php if (auth::user()->dept_category_id === 5): ?>
                                        {!! Form::label('sendtoPM', 'Send To') !!}
                                        <select class="form-control" name="sendtoPM" id="sendtoPM" required="true">
                                            <option value="{{ $johnReedel }}">{{ $johnReedel }}</option>
                                        </select>                                       
                                    <?php elseif (auth::user()->dept_category_id === 2): ?>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <small>
                                        ...
                                        If you want to take half a day leave, please attention to the start leave date, end leave date, and back to work.
                                        </p>
                                        <p>
                                            <span style="color: red;">** </span>
