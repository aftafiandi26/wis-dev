            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-lg-12" align="center">
                        <b class="panel-title">LEAVE APPLICATION FORM ss</b>
                    </div>
                </div>
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <div class="col-lg-1">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('entitlement', $leave, ['class' => 'form-control', 'maxlength' => 100, 'autofocus' => true, 'readonly' => true, 'min' => true, 'id' => 'balanceID']) !!}
                                            </div>
                                        </div>
                                        <div class="col-lg-1">
                                            <div class="form-group">
