    ...
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-3 form-group">
                            ...
                            {!! Form::text('username', Auth::user()->first_name . ' ' . Auth::user()->last_name, [
                                'class' => 'form-control',
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    {!! Form::text('position', Auth::user()->position, [
                        'class' => 'form-control',
                ...
                @if ($errors->has('back_work'))
                    ...
                    @else
                        <div class="form-group">
                            ...
                            <br>
                            {!! Form::date('back_work', old('back_work'), [
                                'class' => 'form-control',
                                'placeholder' => 'Back to Work at',
                                'maxlength' => 100,
                                'required' => true,
                                'id' => 'back_work',
                            ]) !!}
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('join_date', Auth::user()->join_date, [
                                'class' => 'form-control',
                    ...
                    <div class="col-lg-2">
                        ...
                        {!! Form::text('leave_category_id', 'Annual', [
                            'class' => 'form-control',
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    <select class="form-control" name="sendtoPM" required>
                        ...
                        <option value="{{ $pmCategory->email }}">
                            {{ $pmCategory->first_name . ' ' . $pmCategory->last_name }}
                        </option>
                        <?php endforeach ?>
                    </select>
                    <?php endif ?>
            ...
            <div class="col-lg-3">
                ...
                <!-- {!! Form::select('sendtoProducer', $producer, old('sendtoProducer'), [
                    'class' => 'form-control',
                    'required' => true,
                ]) !!}     -->
                <select class="form-control" name="sendtoProducer" required>
                    ...
                    <option value="{{ $producers->email }}">{{ $producers->first_name . ' ' . $producers->last_name }}
                    </option>
                    <?php endforeach ?>
                </select>
                <?php endif ?>
                    ...
                    <div class="form-group">
                        ...
                        @if (auth::user()->gm == 0 and auth::user()->dept_ApprovedHOD == 0 and auth::user()->assistGM == 0)
                            ...
                            <select class="form-control" name="sendtoPM" id="sendtoPM" required="true">
                                <option value="{{ $generalManager->email }}">{{ $generalManager->getFullName() }}
                                </option>
                            </select>
                        @endif
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $('input#endLeave').on('change', function() {
        ...
        $('input#startLeave').on('change', function(e) {
        ...
        $('input#back_work').on('change', function() {
            ...
            if (backWork < endLeave) {
                alert("Sorry, the date you entered doesn't make sense!!");
                alert("This page will be reload");
                location.reload();
            }
