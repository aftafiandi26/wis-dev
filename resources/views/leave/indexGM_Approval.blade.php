...
@section('body')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div>
			@if(auth::user()->gm === 1 and auth::user()->sg === 0)
            ...
            @endif
            @if(auth::user()->gm === 1 and auth::user()->sg === 1)
...
@section('script')
    ...
    $('#tables').DataTable({
        ...
        responsive: true,        
        ajax: '{!! URL::route("leave/getindexGM_Approval") !!}'
    });
    ...
    $(document).on('click','#tables tr td a[title="Detail"]',function(e) {
     ...
     $('#tables1').DataTable({
        ...
        responsive: true,        
        ajax: '{!! URL::route("leave/getIndexMikeApproval") !!}'
    });
