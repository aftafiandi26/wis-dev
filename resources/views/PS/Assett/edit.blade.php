...
<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Edit Item Asset Production Services (LS)</h1>                     
        </div>
    </div>
   <div class="panel-body">
         {!! Form::open(['route' => ['postEditAsssetPS', $aset->id], 'role' => 'form', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) !!}
                    {{ csrf_field() }}
     <div class="row">  
                  <div class="col-lg-3">
                            ...
                            <div class="col-lg-3">                              
                              ...
                              <div class="col-lg-3">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('status', $aset->status, ['class' => 'form-control', 'maxlength' => 50, 'required' => true]) !!}
...
<div class="col-lg-12">  
     {!! Form::submit('Save', ['class' => 'btn btn-sm btn-success']) !!}
        <a class="btn btn-sm btn-warning" href="{!! URL::route('indexAssetPS') !!}">Back</a>
      {!! Form::close() !!}
</div>  
</div> 
</div>                    
