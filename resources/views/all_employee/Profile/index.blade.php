...
@section('body')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="col-lg-2">
                <span class="imgHover">
                    <img src="{{ asset('storage/app/prof_pict/' . Auth::user()->prof_pict . '') }}" alt="img"
                        srcset="" class="img img-circle img-thumbnail image">
                    <button type="button" class="btn btn-default btn-sm middle" data-toggle="modal"
                    ...
                    <div class="col-lg-12">
                        <div class="col-lg-2">
                            ...
                            <input type="text" class="form-control"
                                value="{{ auth()->user()->first_name . ' ' . auth()->user()->last_name }}" id="name"
                                readonly>
                        </div>
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-2">
                            ...
                            <input type="text" class="form-control" value="{{ $dept->dept_category_name }}" readonly
                                id="department">
                        </div>
                    </div>
                </div>
                <div class="row rowBottom">
                    <div class="col-lg-12">
                        <div class="col-lg-2">
                            ...
                            <input type="text" class="form-control" value="{{ auth()->user()->emp_status }}"
                                id="emp_stat" readonly>
                        </div>
                        <div class="col-lg-2">
                        ...
                        <div class="col-lg-2">
                            ...
                            <input type="text" class="form-control" value="{{ auth()->user()->email }}" id="workMail"
                                readonly>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="col-lg-2">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" value="{{ $yourProjects['mainProject'] }}"
                                    id="mainProject">
                                {{-- <div class="input-group-btn">
                                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal"
                                        data-target="#modalProject"
                                        data-role={{ route('employes/profile/modal', [1, auth()->user()->project_category_id_1]) }}
                                        id="ajaxModalProject" title="Change your project"><i class="fa fa-pencil"
                        ...
                        <div class="col-lg-2">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" value="{{ $yourProjects['secondProject'] }}"
                                    id="secondProject">
                                {{-- <div class="input-group-btn">
                                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal"
                                        data-target="#modalProject"
                                        data-role={{ route('employes/profile/modal', [2, auth()->user()->project_category_id_2]) }}
                                        id="ajaxModalProject" title="Change your project"><i class="fa fa-pencil"
                                            aria-hidden="true"></i></button>
                                </div> --}}
                            </div>
                        ...
                        <div class="col-lg-2">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" value="{{ $yourProjects['thirdProject'] }}"
                                    id="thirdProject">
                                {{-- <div class="input-group-btn">
                                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal"
                                        data-target="#modalProject"
                                        data-role={{ route('employes/profile/modal', [3, auth()->user()->project_category_id_3]) }}
                                        id="ajaxModalProject" title="Change your project"><i class="fa fa-pencil"
                                            aria-hidden="true"></i></button>
                                </div> --}}
                            </div>
                        ...
                        <div class="col-lg-2">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" value="{{ $yourProjects['fourProject'] }}"
                                    id="fourProject">
                                {{-- <div class="input-group-btn">
                                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal"
                                        data-target="#modalProject"
                                        data-role={{ route('employes/profile/modal', [4, auth()->user()->project_category_id_3]) }}
                                        id="ajaxModalProject" title="Change your project"><i class="fa fa-pencil"
                                            aria-hidden="true"></i></button>
                                </div> --}}
                            </div>
                ...
                <div class="col-lg-2">
                    ...
                    <form action="{{ route('employes/profile/post/nickname') }}" method="post">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-btn">
                                <button type="submit" class="btn btn-sm btn-success"><i class="fa fa-pencil"
                                        aria-hidden="true"></i></button>
                            </div>
                        </div>
                    </form>
                    ...
                    <form action="{{ route('employes/profile/post/phone') }}" method="post">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="phoneNumber"
                                value="{{ auth()->user()->phone }}" name="phoneNumber">
                            <div class="input-group-btn">
                                <button type="submit" class="btn btn-sm btn-success"><i class="fa fa-pencil"
                                        aria-hidden="true"></i></button>
                            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-2">
                    ...
                    <form action="{{ route('employes/profile/post/educationInstitution') }}" method="post">
                        {{ csrf_field() }}
                        <div class="input-group">
                            <input type="text" class="form-control" id="education_institution"
                                name="education_institution" value="{{ auth()->user()->education_institution }}">
                            <div class="input-group-btn">
                                <button type="submit" class="btn btn-sm btn-success"><i class="fa fa-pencil"
                                        aria-hidden="true"></i></button>
                            </div>
        ...
        <div class="row rowBottom">
            <div class="col-lg-12">
                <div class="col-lg-2">
                    ...
                    <input type="text" class="form-control" id="Ketenagakerjaan"
                        value="{{ auth()->user()->bpjs_ketenagakerjaan }}">
                </div>
                <div class="col-lg-2">
                    <label for="kesehatan">BPJS Kesehatan</label>
                    <input type="text" class="form-control" id="kesehatan"
                        value="{{ auth()->user()->bpjs_kesehatan }}">
                </div>
                <div class="col-lg-2">
                    ...
                    <form action="{{ route('employes/profile/post/dormRoom') }}" method="post">
                        {{ csrf_field() }}
                        <div class="input-group">
                            <input type="text" class="form-control" id="dormRoom" name="dormRoom"
                                value="{{ auth()->user()->rusun }}">
                            <div class="input-group-btn">
                                <button type="submit" class="btn btn-sm btn-success"><i class="fa fa-pencil"
                                        aria-hidden="true"></i></button>
                            </div>
                        ...
                        <div class="input-group">
                            <select name="dormStatus" id="dormStatus" class="form-control">
                                @foreach ($dorm_stat as $share)
                                    <option value="{{ $share }}" @if ($share == auth()->user()->rusun_stat) selected @endif>
                                        {{ $share }}</option>
                                @endforeach
                            </select>
                            <div class="input-group-btn">
        ...
        <div class="modal fade" id="myModal" role="dialog">
            <div class="modal-dialog modal-sm">
                <form action="{{ route('employes/profile/post', auth()->user()->id) }}" method="post"
