...
@section('body')
    ...
    <div class="modal fade" id="modalDetail" tabindex="-1" role="dialog" aria-labelledby="showModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="modalReminder" tabindex="-1" role="dialog" aria-labelledby="showModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
    ...
    <script>
        $(document).ready(function() {
            $('table#tables').DataTable({
                processing: true,
                responsive: true,
                ajax: "{{ route('all_employes/leave/transaction/coordinator/data') }}",
                columns: [{
                        data: 'DT_Row_Index',
                        orderable: false,
                        searchable: false
