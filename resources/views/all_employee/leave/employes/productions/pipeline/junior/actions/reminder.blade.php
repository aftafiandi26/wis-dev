<form action="{{ route('all_employes/leave/transaction/hd/mail/post', $id) }}" method="post">
    {{ csrf_field() }}
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="text" id="email" class="form-control" value="{{ $status->getFullName() }} ['{{ $status->email }}';]" readonly>
