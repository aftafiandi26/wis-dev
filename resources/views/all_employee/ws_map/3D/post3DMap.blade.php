...
@section('body')
 ...
 <div class="row">
  ...
  <div class="row">
    <form class="form-horizontal" action="{{route('postInputData3DMap', [$animasi->id])}}" method="POST" enctype="multipart/form-data">     
    ...
    <div class="form-group">
     ...
     <div class="form-group">        
      <div class=" col-lg-offset-1  col-lg-12">       
          ...
          <a href="{{route('indexMAP')}}" class="btn btn-sm btn-warning" title="Back to Index MAP">Back</a>
      </div>     
    </div>
