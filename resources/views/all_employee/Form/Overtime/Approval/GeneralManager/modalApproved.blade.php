...
<div class='modal-footer'>
    <button class="btn btn-primary" data-role="{{ route('form/approval/generalmanager/approved/post', $form->id) }}" title="approved" id="approved">Approve</button>
    <button class="btn btn-danger" data-role="{{ route('form/approval/generalmanager/disapproved/post', $form->id) }}" title="disapproved" id="disapproved">Disapprove</button>
    <button class="btn-dafault btn" data-dismiss='modal' type="button"></button>
</div> ";
