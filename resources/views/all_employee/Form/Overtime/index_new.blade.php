            ...
            <div class="panel-body">
                ...
                <form action="{{ route('form/overtime/post') }}" method="post" class="needs-validation">
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="requested" id="requested" class="form-control"
                        ...
                        <div class="col-lg-2" id="startPicker">
                            <div class="form-group">
                                ...
                                <div class="input-group date" data-date-format="dd.mm.yyyy">
                                    <input type="text" name="startOvertime" id="startOvertime" class="form-control"
                        ...
                        <div class="col-lg-2" id="endPicker">
                            <div class="form-group">
                                ...
                                <div class="input-group date" data-date-format="dd.mm.yyyy">
                                    <input type="text" name="endOvertime" id="endOvertime"
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="endDate" id="endDate" class="form-control"
                                    value="{{ auth()->user()->end_date }}" readonly>
                            </div>
                        </div>
                        <div class="col-lg-4"></div>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="department" id="department" class="form-control"
                                    value="{{ auth()->user()->department['dept_category_name'] }}" readonly>
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                    ...
                    <div class="row" id="rowVPN">
                        <div class="col-lg-2">
                            <div class="form-group">
                                <label class="checkbox-inline" for="vpn"><input type="checkbox" name="vpn"
                                        id="vpn" checked>Open Remote Access (VPN)</label>
                            </div>
                        </div>
                        <div class="col-lg-4"></div>
                    </div>
                        ...
                        <div class="col-lg-4" id="divReason">
                            <div class="form-group">
                                ...
                                <textarea name="reason" id="reason" cols="30" rows="10" class="form-control"
                                    placeholder="minimal 15 character" required></textarea>
                            </div>
                        </div>
                    </div>
