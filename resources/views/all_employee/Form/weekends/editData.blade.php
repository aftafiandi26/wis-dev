            ...
            <div class="col-lg-12">
                ...
                <div class="form-group">
                    ...
                    <select name="workStatus" class="form-control">
                        ...
                        <option value="wfs" @if ('wfs' == $data->workStat) selected @endif>WFS</option>
                        <option value="wfh" @if ('wfh' == $data->workStat) selected @endif>WFH</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <label><input type="checkbox" name="lunch" value="1"
                            @if ($data->lunch == true) checked @endif>
                        Lunch</label>
                    <label><input type="checkbox" name="dinner" value="1"
                            @if ($data->dinner == true) checked @endif>
                        Dinner</label>
                </div>
            </div>
        </div>
