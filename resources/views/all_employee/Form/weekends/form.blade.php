...
@push('style')
    ...
    <link rel="stylesheet"
        href="https://cdn.jsdelivr.net/npm/@eonasdan/tempus-dominus@5.39.0/dist/css/tempus-dominus.min.css">
    ...
    <style>
        ...
        .table-wrapper {
            overflow-y: auto;
            /* Mengaktifkan scrolling vertikal pada container */
            max-height: 500px;
        ...
        .table-wrapper table {
            ...
            width: 100%;
            white-space: nowrap;
            /* Menghindari wrapping pada teks dalam sel */
        }
        ...
        .table-wrapper thead th {
            ...
            /* Atur warna latar belakang th sesuai kebutuhan */
        }
        ...
        .table-wrapper tbody::-webkit-scrollbar-thumb {
            ...
            /* Warna dari thumb scrollbar */
            border-radius: 4px;
            /* Membuat thumb lebih berbentuk bulat */
        }
...
@section('body')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Weekend Crew</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
                                    ...
                                    <tbody>
                                        @foreach ($workings as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-default" id="edit" data-toggle="modal"
                                                        data-target="#modalEditData"
                                                        data-role="{{ route('coordinator/working/weekends/edit', $data['id']) }}"
                                                        title="reschedule this emlpoyee">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a class="btn btn-sm btn-default" id="delete" data-toggle="modal"
                                                        data-target="#modalDeleteData"
                                                        data-role="{{ route('coordinator/working/weekends/delete', $data['id']) }}"
                                                        title="remove this recorded.">
    ...
    <div class="modal fade" id="modalDate" tabindex="-1" role="dialog" aria-labelledby="showModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="modalEditData" tabindex="-1" role="dialog" aria-labelledby="showModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
    ...
    <div class="modal fade" id="modalDeleteData" tabindex="-1" role="dialog" aria-labelledby="showModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
    ...
    <div class="modal fade" id="modalPusher" tabindex="-1" role="dialog" aria-labelledby="showModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('coordinator/working/weekends/send/data') }}" method="post" class="form-inline">
                    ...
                    <div class='modal-body'>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h4 id="attention" class="text-center">Please double check the data you will send, the
                                    data you will send cannot be changed!!</h4>
                            </div>
                        </div>
                    </div>
