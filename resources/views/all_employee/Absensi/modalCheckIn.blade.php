<div class="modal-content">
    ...
    <div class="modal-body">
        <form action="{{ route('attendance/checkin/post') }}" method="post" class="form-horizontal">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text"name="value_work" class="form-control" id="value_work" required readonly>
                </div>               
            </div>
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <button type="submit" class="btn btn-default btn-sm" style="margin-right: 10xp;">Check In</button>
