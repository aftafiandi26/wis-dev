...
<div class="row">
  <div class="col-lg-6">
    <form action="{{ route('updateGetListDataAttendance', [$id]) }}" method="post">
      {{ csrf_field() }}
      ...
      <div class="form-group">
        ...
        <input type="time" class="form-control" id="check_out" name="check_out" value="{{ $absences->timeOUT }}">
        @else
        <input type="time" class="form-control" id="check_out" name="check_out" value="{{ $absences->timeOUT }}">
        @endif
      </div>
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" name="remark" title="remark" maxlength="100" placeholder="max word 100 !!">{{$absences->remarks or ''}}</textarea>
      </div>
