...
@section('body')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Change Employee Privilege</h1>
        </div>
    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h5 class="panel-title">
                        <b>Form Change Employee Privilege</b>
                    </h5>
                </div>
                 <div class="panel-body">
                    {!! Form::open(['route' => ['postEditprivellage', $users->id], 'role' => 'form', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) !!}
                    {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-2">
                                @if ($errors->has('nik'))
                            ...
                            <div class="col-lg-2">
                             ...
                             <div class="col-lg-2">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('position', $dept->dept_category_name, ['class' => 'form-control', 'placeholder' => 'Position', 'maxlength' => 100, 'readonly' => true]) !!}
                       ...
                       <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal">Save</button>
                        ...
                        <a class="btn btn-sm btn-warning" href="{!! URL::route('privilege') !!}">Back</a>
                        <!-- Modal -->
