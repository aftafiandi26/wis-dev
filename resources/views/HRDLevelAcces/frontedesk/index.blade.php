...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Stationary Stock ATK</h1> 
    </div>
</div>
<div class="row">
<div class="col-lg-12">
    <a href="{{route('Stationary/addStockStatoonary')}}" class="btn btn-sm btn-default">Add Stock</a>
        ...
        <tbody>
            ...
            <tr>
                  ...
                  <td style="text-align: center;">
                    <a data-toggle="modal" data-target="#showModal" title="view" data-role="{{ route('mineral/modalMineralViewTable', [$value->kode_barang, $i]) }} " style="color: black;">
                  ...
                  <td><a href="{{route('Statoonery/indexInStock', [$value->id])}}" class="btn btn-xs btn-default" id="in">In</a></td>
                  <td><a href="{{route('Statoonery/indexOutStock', [$value->id])}}" class="btn btn-xs btn-default" id="out">Out</a></td>
