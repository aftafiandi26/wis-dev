<div class="modal-header">
                ...
                <tbody>
                    @foreach ($transactions as $key => $transaction)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-xs btn-default" title="edit this transaction" id="edit" href="{{ route('stationery/atk/transaction/edit', [$transaction->id]) }}"><i class="fa fa-pencil"></i></a>
  ...
  <div class="modal-footer">
    <a href="{{ route('stationery/atk/transactions/index', [$water->kode_barang, date('Y-m').'-'.$date]) }}" class="btn btn-sm btn-default" title="Detail Transaction for this {{ date('Y-m') }}-{{ $date }}" id="detailTransaction">Detail</a>
