...
<form action="{{ route('stationery/atk/category/update', [$category->id]) }}" method="post" class="form-horizontal">
    ...
    <div class="modal-footer">
        <a href="{{ route('stationery/atk/transactions/index', [$category->unik_kategori, date('Y-m', strtotime($month))]) }}" class="btn btn-sm btn-default pull-left" id="detailTransaction">Detail</a>
