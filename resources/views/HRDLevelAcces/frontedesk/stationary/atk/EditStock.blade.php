...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Edit Stationary</h1> 
    </div>
</div>
@if ($errors->any())
...
<div class="row">
    <div class="col-lg-10">
        <div>
            <form action="{{route('stationery/atk/update', [$stock->id])}}" method="post">
               {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <input type="text" name="qty" id="qty" value="{{$stock->stock_barang}}" required="true" class="form-control">
              </div>
              <div class="form-group">
