...
<style type="text/css">
  ...
  <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Edit Employee Medic <sup><small class="sup">(ID MC : {{$leave->id.'-'.$medic->id}})</small></sup></h1>
...
<div class="row">
   ...
   <div class="col-lg-12">
       <form action="{{ route('sicked/summary/update', [$medic->id]) }}" method="post" enctype="multipart/form-data">
           {{ csrf_field() }}
          ...
          <div class="col-lg-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-2">
                       ...
                       <input type="text" name="nameHospital" id="nameHospital" class="form-control" value="{{ $medic->hospital_name }}"> 
                    </div>
                    <div class="col-lg-2">
                    ...
                    <div class="col-lg-2">
                       ...
                       <input type="text" name="age" id="age" class="form-control" value="{{ $medic->age }}"> 
                    </div>                    
                    <div class="col-lg-2">
                       <label for="dateSicked">Sicked</label>
                       <input type="date" name="dateSicked" id="dateSicked" class="form-control" value="{{ $medic->sicked_date }}"> 
                    </div>  
                    <div class="col-lg-2">
                       <label for="dateHealed">Healed</label>
                       <input type="date" name="dateHealed" id="dateHealed" class="form-control" value="{{ $medic->healed_date }}"> 
                    </div>                            
                </div>
           </div>
           <div class="col-lg-12" style="margin-top: 7px; margin-bottom: 7px;">
                <div class="col-lg-2">
                       <label for="totDay">Total Day <sup><small class="sup">(day)</small></sup></label>
                       <input type="text" name="totDay" id="totDay" class="form-control" value="{{ $medic->count_sicked }}"> 
                    </div>    
                    <div class="col-lg-2">
                       <label for="address">Address</label>
                       <input type="text" name="address" id="address" placeholder="input address" class="form-control" value="{{ $medic->address_sick }}"> 
                    </div>                        
           </div>
                ...
                <div class="form-group">                 
                    <div class="col-lg-4">
                        <table class="table table-sm table-responsive">
                            ...
                            <tbody id="itemlist">
                               <?php foreach ($disease as $key => $valueDisease): ?>
                                    <?php $nomor = $key + 25; ?>
                                   <tr>
                                       <td>
                                           <select class="form-control" name="categoryDisease[{{$nomor}}]" required id="selected">
                                               <?php foreach ($jenis_penyakit as $jenis): ?>
                                                   <option value="{{ $jenis }}" 
                                                   <?php if ($jenis === $valueDisease->category): ?>
                                                       selected
                                                   <?php endif ?>
                                                   >{{ $jenis }}</option>
                                               <?php endforeach ?>
                                        ...
                                        <td><input name="diseaseName[{{$nomor}}]" class="form-control"  type="text" required="true" value="{{ $valueDisease->disease }}" /></td>
                                        <td><input name="period[{{$nomor}}]" class="form-control"  type="text" required="true" value="{{ $valueDisease->period }}" /></td>
                                        <td><a href="{{ route('sicked/summary/delete', [$valueDisease->id]) }}" class="btn-xs btn btn-danger"><i class="fa fa-minus"></i></a></td>
                                   </tr>
                               <?php endforeach ?>
                            </tbody>
                             <tfoot>
                    ...
                    <div class="col-lg-2">
                           ...
                           <img class="img-preview img-fluid" width="250px" height="250px" alt="" src="{{ $storageImg }}"> 
                           <input type="file" name="scan" id="scan" placeholder="input scan" class="form-control"  onchange="previewImage()">
                    </div>  
                    <div class="col-lg-4" style="margin-top: 20px;">                        
                          <button type="submit" class="btn btn-sm btn-success">add</button>
                          <a href="{{ route('sicked/summary') }}" class="btn btn-default btn-sm">back</a>
                    </div>                  
...
//                membuat element input
                ...
                hapus.innerHTML = '<button class="btn btn-small btn-default"><i class="glyphicon glyphicon-trash"></i></button> <a href="<?php route('index') ?>" class="btn btn-default btn-sm">back</a>';
//                Aksi Delete
