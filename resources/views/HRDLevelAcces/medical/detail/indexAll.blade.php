...
<script src="https://cdn.datatables.net/1.11.5/js/jquery.dataTables.min.js"></script>
  <div class="row">
    ...
    <div class="row" style="margin-bottom: 10px;">
     ...
     <div class="row" style="margin-bottom: 10px;">
        <div class="col-lg-12">
           <a href="{{ route('details/summary/all/excel', [$dateFrom, $dateToo, $category]) }}" class="btn btn-default">Excel</a>
        </div>
    </div>
     ...
     <div class="row">
        <div class="col-lg-12">
            <table class="table table-striped table-bordered table-hover display" width="100%" id="tablesMedical">
             ...
             <span>Showing {{ $medic->firstItem() }} to {{ $medic->lastItem() }} of {{ $medic->total() }} data</span>
            <span class="pull-right" style="margin-top: -20px;"> {{ $medic->appends($_GET)->render() }}</span>         
        </div>      
    </div>
...
<script type="text/javascript">
    ...
    title: {
        text: 'Disease percentage in <br> <b>{{ date("d-M-Y", strtotime($dateFrom)) }}</b> to <b>{{ date("d-M-Y", strtotime($dateToo)) }}</b>'
    },
    tooltip: {
