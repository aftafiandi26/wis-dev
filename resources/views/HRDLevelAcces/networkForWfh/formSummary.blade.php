                    ...
                    <tbody>
                        <tr class="text-red">
                            <th>Bandwidth <sup>(Mbps)
                                    <a href="https://www.speedtest.net/id" class="btn btn-xs btn-default" target="_blank"
                                        rel="noopener noreferrer">check</a>
                                </sup> </th>

                            <th>
                                <input type="number" min="0" value="{{ $data->bandwidth }}" required placeholder="0"
                                    class="input-number">
                            </th>
                            <th>
            ...
            <div class="col-lg-12">
                <table class="table table-bordered table-condensed">
                    ...
                    <tr>
                        ...
                        <th>
                            <input type="radio" name="vpn03_stat" id="vpn03_stable" class="custom-radio" value="1"
                                @if ($data->vpn03_stat === 1) checked @endif disabled>
                ...
                <table class="table table-condensed table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <th>Confirm:</th>
                            <th>
                                <input type="radio" id="confirm_accept" class="custom-radio" required value="1"
                                    name="confirmed" @if ($data->hr == 1) checked @endif>
                                <label for="confirm_accept">Accept</label>
                                <input type="radio" id="confirm_reject" class="custom-radio" required value="2"
                                    name="confirmed" @if ($data->hr == 2) checked @endif>>
                        ...
                        <tr>
                            ...
                            <th>
                                <textarea name="suget_hr" id="suget_hr" cols="30" rows="3" required>{{ $data->suget_hr }}</textarea>
                            </th>
                        </tr>
                    </tbody>
                </table>
