...
@section('body')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Summary Attendances</h1>
        </div>
    </div>
    ...
    <div class="row mb-10">
        <div class="col-lg-12">
            ...
            <div class="col-lg-6">
                <a class="btn btn-sm btn-default pull-right" id="add" data-toggle="modal" data-target="#modalAdd"
                    title="Insert attendance">Add</a>
                <a class="btn btn-sm btn-default pull-right ml-3" id="chart" data-toggle="modal"
                    data-target="#modalChart" title="chart attendance">Chart</a>
            </div>
        </div>
    </div>
            ...
            <table class="table table-condensed table-hover table-striped table-bordered" id="tables" width="100%">
                <thead>
                    <tr>
                        ...
                        <th>Total Time</th>
                        <th>Status</th>
                        <th>How you're feeling?</th>
                        <th>How's your health?</th>
                        <th>Actions</th>
                    </tr>
                </thead>
            </table>
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="showModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="modalDelete" tabindex="-1" role="dialog" aria-labelledby="showModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
    ...
    <div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-labelledby="showModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="remarks" id="remarks" cols="30" rows="10" placeholder="type hit.."
                                        class="form-control text-lowercase"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modalChart" tabindex="-1" role="dialog" aria-labelledby="showModalLabelChart"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content" id="modal-content-modals">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="{{ route('hr/summary/attendance/chart/get') }}" method="post"
                                class="form-inline" id="formChart">
                                {{ csrf_field() }}
                                <div class="form-grop">
                                    <label for="date">date:</label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-default submitFormChart"
                        id="submitFormChart">Submit</button>
