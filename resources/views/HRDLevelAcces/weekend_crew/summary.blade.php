...
@push('style')
    <style>
        table#tables1 a#table1Detail,
        table#tables3 a#table1Detail {
            background-color: greenyellow;
            color: black;
        }

        table#tables1 a#table1Detail:hover,
        table#tables3 a#table1Detail:hover {
        ...
        table#tables3 a#table1Detail:active,
        table#tables1 a#table1Detail:active {
            background-color: greenyellow;
            color: white;
        }
...
@section('body')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Summary Weekend Crew</h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-5">
            <div class="panel panel-primary">
                <div class="panel-heading">Submissions Tables <span id="subHeadline">(ongoing)</span></div>
                <div class="panel-body ">
                    <table class="table table-responsive table-condensed table-hover table-striped table-bordered"
                        width="100%" id="tables1">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Weekend Crew</th>
        ...
        <div class="col-lg-7">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-condensed table-hover table-striped table-bordered" width="100%"
                        id="tables2">
                        <thead>
                            <tr>
                                <th>No</th>
                    ...
                    <h4 class="blinking-text">Catch Up</h4>
                    <table class="table table-condensed table-hover table-striped table-bordered" width="100%"
                        id="tables5">
                        <thead>
                            <tr>
    ...
    <div class="modal fade" id="modalTable1Danger" tabindex="-1" role="dialog" aria-labelledby="showModalLabel"
        aria-hidden="true">
