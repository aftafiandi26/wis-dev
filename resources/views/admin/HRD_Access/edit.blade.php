...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.5.0/css/all.css" integrity="sha384-B4dIYHKNBt8Bc12p+WXckhzcICo0wtJAoU8YZTY5qE0Id1GSseTk6S+L3BlXeVIU" crossorigin="anonymous">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">HRD Access Level</h1>
        </div>
    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h5 class="panel-title">
                        <b>Form HRD Access Level</b>
                    </h5>
                </div>
                 <div class="panel-body">
                   <div class="row">
                      {!! Form::open(['route' => ['hrd-post', $users->id], 'role' => 'form', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) !!}
                    {{ csrf_field() }}
                     <div class="col-lg-2">
                                @if ($errors->has('nik'))
...
<a class="btn btn-sm btn-warning" href="{!! URL::route('HRD-Access') !!}">Back</a>
                        <!-- Modal -->
