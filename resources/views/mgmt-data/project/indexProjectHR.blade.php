...
@section('body')
    ...
    <div class="row">
        <div class="col-lg-6">
            <div align="right">
                <a style="margin-bottom: 15px;" class="btn btn-sm btn-primary" data-original-title="Add" data-toggle="tooltip" data-placement="top" href="{!! URL::route('hr_mgmt-data/project/create') !!}"><span class="fa fa-plus"></span></a>
            </div>
...
@section('script')
    ...
    $('#tables').DataTable({
        ...
        responsive: true,
        ajax: '{!! URL::route("hr_mgmt-data/project/getindexProject") !!}'
    });
@stop