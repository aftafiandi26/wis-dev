            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h5 class="panel-title">
                        <b>Form Edit Department</b>
                    </h5>
                </div>

                <div class="panel-body">
                    {!! Form::open(['route' => ['mgmt-data/department/update-data', $dept->id], 'role' => 'form', 'autocomplete' => 'off']) !!}
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('department', $dept->dept_category_name, ['class' => 'form-control', 'placeholder' => 'Department', 'maxlength' => 100, 'autofocus' => true, 'required' => true]) !!}
