        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::open(['route' => 'mgmt-data/user/store', 'role' => 'form', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) !!}
                    {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('project', old('project'), ['class' => 'form-control', 'placeholder' => 'Project', 'maxlength' => 100, 'autofocus' => true]) !!}
