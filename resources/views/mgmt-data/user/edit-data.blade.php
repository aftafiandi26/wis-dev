...
@section('body')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Change Data  User</h1>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::open(['route' => ['mgmt-data/user/update-data', $users->id], 'role' => 'form', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) !!}
                    {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-2">
                                ...
                                @endif
                					...
                					{!! Form::text('username', $users->username, ['class' => 'form-control', 'placeholder' => 'Username', 'maxlength' => 20, 'readonly' => false]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                ...
                                @else
                                    <div class="form-group">
                                @endif
                                    {!! Form::label('emp_status', 'Emp. Status') !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('project', $users->project, ['class' => 'form-control', 'placeholder' => 'Project', 'maxlength' => 100, 'autofocus' => true]) !!}
