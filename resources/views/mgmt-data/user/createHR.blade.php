...
@section('body')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Add User Data</h1>
        </div>
    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h5 class="panel-title">
                        <b>Form Add User Data</b>
                    </h5>
                </div>

                <div class="panel-body">
                    {!! Form::open(['route' => 'hr_mgmt-data/user/store', 'role' => 'form', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) !!}
                    {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-2">
                                ...
                                @endif
                                    {!! Form::label('username', 'Username') !!}<font color="red"> (*)</font>
                					{!! Form::text('username', old('username'), ['class' => 'form-control', 'placeholder' => 'Username', 'maxlength' => 100, 'autofocus' => true, 'required' => true]) !!}
                            ...
                            <!-- <div class="col-lg-2">
                                ...
                                @else
                                    <div class="form-group">
                                @endif
                                    {!! Form::label('level', 'Level Access') !!}<font color="red"> (*)</font>
                                    {!! Form::select('level', $level, old('level'), ['class' => 'form-control', 'maxlength' => 5, 'required' => true]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('province', old('province'), ['class' => 'form-control', 'placeholder' => 'Province', 'maxlength' => 100, 'autofocus' => true]) !!}
                            ...
                            <div class="col-lg-2">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('email', old('email'), ['class' => 'form-control', 'placeholder' => 'Email', 'maxlength' => 100, 'autofocus' => true, 'required' => true]) !!}
                            ...
                            <div class="col-lg-2">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('education', old('education'), ['class' => 'form-control', 'placeholder' => 'Education', 'maxlength' => 100, 'autofocus' => true]) !!}
                           ...
                           <!-- <div class="col-lg-2">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('race', old('race'), ['class' => 'form-control', 'placeholder' => 'Race', 'maxlength' => 100, 'autofocus' => true]) !!}
                            ...
                            <div class="col-lg-2">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('religion', old('religion'), ['class' => 'form-control', 'placeholder' => 'Religion', 'maxlength' => 100, 'autofocus' => true]) !!}
                           ...
                           <!-- <div class="col-lg-2">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('dependent', old('dependent'), ['class' => 'form-control', 'placeholder' => 'Dependent', 'maxlength' => 100, 'autofocus' => true]) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                ...
                                @else
                                    <div class="form-group">
                                @endif
                                    {!! Form::label('project_category_id_1', 'Project') !!}
                                    {!! Form::select('project_category_id_1', $project1, old('project_category_id_1'), ['class' => 'form-control']) !!}
                          ...
                          <!--  <div class="col-lg-2">
                                ...
                                @else
                                    <div class="form-group">
                                @endif
                                    {!! Form::label('project_category_id_2', 'Project 2') !!}
                        ...
                        <a class="btn btn-sm btn-warning" href="{!! URL::route('hr_mgmt-data/user') !!}">Back</a>
                        {!! Form::close() !!}
                        </div>
                        </div>
                </div>
