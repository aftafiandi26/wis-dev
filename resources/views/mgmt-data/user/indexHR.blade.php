...
@section('body')
    ...
    <div class="row">
        <div class="col-lg-12">
			<div align="right">
				<a style="margin-bottom: 15px;" class="btn btn-sm btn-primary" data-original-title="Add" data-toggle="tooltip" data-placement="top" href="{!! URL::route('hr_mgmt-data/user/create') !!}"><span class="fa fa-plus"></span></a>
			</div>
...
@section('script')
    ...
    $(document).on('click','#tables tr td a[title="Detail"]',function(e) {
     ...
     $(document).on('click','[title="Reset Password"]',function(e) {
        var id = $(this).attr('data-role');
