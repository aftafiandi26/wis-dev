        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::open(['route' => ['hr_mgmt-data/initial/store', $users->id], 'role' => 'form', 'autocomplete' => 'off']) !!}
                        <div class="row">
                            <div class="col-lg-2">
                                @if ($errors->has('NIK'))
                            ...
                            <div class="col-lg-2">
                                ...
                                @else
                                    <div class="form-group">
                                @endif
                                    {!! Form::label('input_date', 'Exdo Expired') !!}<font color="red"> (*)</font><br>
                                    {!! Form::date('input_date', null, ['class' => 'form-control']) !!}
                                    <font color="red">
                                    <p><small> exdo expiration is set on <b>2021-12-31 <sup>(**)</sup></b></small></p>
                                    </font>
                            ...
                            <!-- <div class="col-lg-2">
                                ...
                                @endif
                                    ...
                                    {!! Form::date('exp_date', null, ['class' => 'form-control', 'required' => true, 'readonly' => true ]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('initial', old('initial'), ['class' => 'form-control', 'placeholder' => 'Number', 'maxlength' => 3, 'required' => true]) !!}
                            ...
                            <div class="col-lg-4">
                                ...
                                @endif
                                    ...
                                    {!! Form::text('note', old('note'), ['class' => 'form-control', 'placeholder' => 'Note']) !!}
