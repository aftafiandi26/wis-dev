<div class="modal-content">
    ...
    <div class="modal-footer">
        <a href="{{ route('producer/exdo-extend/approval', $data->id) }}" class="btn btn-sm btn-primary">Approval</a>
        <a href="{{ route('producer/exdo-extend/disapproval', $data->id) }}" class="btn btn-sm btn-danger">Disapproval</a>
