...
<div class='modal-footer'>
    <a href={{ route('producer/weekend-crew/approved', $getId->id) }} class='btn btn-sm btn-default'
        id="approved">Approve</a>
    <a href="{{ route('producer/weekend-crew/disapproved', $getId->id) }}" class='btn btn-sm btn-default'
        id="disapproved">Reject</a>
