...
@section('body')
    ...
    <div class="row">
        <div class="col-lg-12">
           <!--  <div align="right">
              <a style="margin-bottom: 15px;" class="btn btn-sm btn-info" data-original-title="Chart Diagram" data-toggle="tooltip" data-placement="top" href="{!! URL::route('ap_koor/tambah') !!}"><span>Chart</span></a>
            </div> -->
...
@section('script')
    ...
    $('#tables').DataTable({
        ...
        "order": [
         ...
         processing: true,
        responsive: true,        
        ajax: '{!! URL::route("Koordinator/getHistori") !!}'
    });
