...
<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">List Workstation</h1> 
        </div>
    </div> 
     <div class="col-lg-12">
       @if(auth::user()->dept_category_id === 1)
      <div align="right">
        <a style="margin-bottom: 15px;" class="btn btn-sm btn-info" data-original-title="Add" data-toggle="tooltip" data-placement="top" href="{{ route('add-WS') }}"><span class="fa fa-plus"></span> Workstation</a>
      </div>
        @endif
       <div>   
...
@section('script')
    ...
    $('#tables').DataTable({
        ...
        ajax: '{!! URL::route("get_indexWS_AvailabilityPipeline") !!}'
    });    
