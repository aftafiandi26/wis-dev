...
@section('body')
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">Form Weekend Crew <span id="homan">(Unpaid / Catch Up)</span></div>
                <div class="panel-body">
                    <table class="table table-condensed table-hover table-striped table-bordered" width="100%"
                        id="catchup">
                        <thead>
    ...
    <div class="modal fade" id="modalAction" tabindex="-1" role="dialog" aria-labelledby="showModalLabel"
        aria-hidden="true">
...
@push('js')
    <script>
        $(document).ready(function() {
            ...
            $('table#catchup').DataTable({
                processing: false,
                responsive: true,

                ajax: "{{ route('gm/working-on-weekends/catchup') }}",
                columns: [{
                        "data": "DT_Row_Index",
                        orderable: false,
                        searchable: false
            ...
            $(document).on('click', '#catchup tr td a[id="detail"]', function(e) {
                var id = $(this).attr('data-role');
