...
@section('title')
    Employee Time Sheet - filter Range - Days (gm)
@stop
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                Employee Project Time Sheet <sup>(Days Counting)</sup>
            </h1>
        </div>
    </div>
...
@push('js')
    <script>
        $(document).ready(function() {
            let urlDataFillter = "{{ route('gm/employee-time-sheet/filterDay/data', [$startDate, $endDate]) }}";
