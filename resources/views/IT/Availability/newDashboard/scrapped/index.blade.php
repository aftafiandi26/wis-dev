...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Scrapped Workstation</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
...
$('table#workstations').DataTable({
    prosessing: true,
    responsive: true,
    ajax: '{{ route('workstations/availability/scrapped/data') }}',
    columns: [
...
$(document).on('click','#workstations tr td a[id="delete"]',function(e) {
