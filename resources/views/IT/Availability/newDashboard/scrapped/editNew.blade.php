...
@section('title')
    (it) Edit Data Scrapped Workstation
@stop
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Edit Data Scrapped Workstations</h1>
    </div>
</div>
   ...
   <div class="col-lg-12">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('workstations/availability/scrapped/update', [$workstations->id]) }}" method="post">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a href="{{ route('workstations/availability/scrapped/index') }}" class="btn btn-sm btn-default">Back</a>
                        </div>
                    </div>
                </form>
