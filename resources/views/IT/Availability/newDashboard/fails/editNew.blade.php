   ...
   <div class="col-lg-12">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('workstations/availability/fails/update', [$workstations->id]) }}" method="post">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a href="{{ route('workstations/availability/fails/index') }}" class="btn btn-sm btn-default">Back</a>
                        </div>
                    </div>
                </form>
