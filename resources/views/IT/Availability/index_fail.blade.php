...
<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Failed Workstations</h1> 
        </div>
    </div> 
     <div class="col-lg-12">
...
@section('script')
    ...
    $('#tables').DataTable({
        "columnDefs": [
           { className: "never", "searchable": false, "orderable": false, "visible": false, "targets": [0, 7, 9] }
        ],
        "order": [
           [0, "asc" ]
        ],
