...
<div class="row" style=" margin-bottom: 10px;">
        <div class="col-sm-12">
          <a href="{{route('loadHTML3D_Animation')}}" class="btn btn-warning btn-sm" target="_blank">PDF</a>  
          <!-- <a href="{{route('tes')}}"  class="btn btn-info btn-sm"> tes</a>     -->     
    ...
    <button type="button" onclick="zoomout()">  
        Zoom-Out 
          ...
          <a href="{{route('ExcellAnimation')}}" class="btn btn-default btn-sm">Excel</a> 
        </div>
    </div> 
<div class="container-fluid"><div class="scroll"> 
<div class="btn-sm" style="width: 3500px;">   
    <div class="row" id="geeks" GFG="250">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postData3DMap', [$anim_1->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>              
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
               <center><a href="{{route('postData3DMap', [$anim_2->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_3->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>           
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_4->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>             
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_5->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>             
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_6->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>              
              </div>         
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_7->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>              
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_8->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>              
              </div>
            </div>            
        </div>
     ...
     <div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_9->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>              
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_10->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>              
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_11->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>             
              </div>         
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_12->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_13->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>                
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_14->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>                
              </div>         
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_15->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>                
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_16->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>                
              </div>
            </div>            
        </div>
     ...
     <div style="width: 180px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_17->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_18->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>                
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_19->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
          ...
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_20->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_21->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>              
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_22->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>        
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_23->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_24->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>                
              </div>
            </div>            
        </div>
     ...
     <div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_25->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_26->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_27->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>              
              </div>        
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_28->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_29->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>             
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_30->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>          
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_31->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>
            </div>
            <div class="panel panel-default">
     ...
     <div style="width: 180px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_33->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_34->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_35->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>        
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_36->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>                <
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_37->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_38->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>           
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_39->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>                
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_40->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>                
              </div>
            </div>            
        </div>
     ...
     <div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_41->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_42->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>              
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_43->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>             
              </div>       
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_44->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_45->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>              
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_46->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>              
              </div>      
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_47->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>                
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_48->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
     ...
     <div style="width: 180px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default" style="margin-top: 130px;">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_156->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>
            </div>           
            <div class="panel panel-default" style="margin-top: 87px;">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_49->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>             
              </div>          
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_50->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>              
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_51->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>            
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_52->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>               
              </div>        
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_53->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
            ...
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_54->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>             
              </div>
            </div>            
        </div>
     ...
     <div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default" style="margin-top: 130px;">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_157->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>           
            <div class="panel panel-default" style="margin-top: 87px;">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_55->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>         
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_56->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_57->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_58->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>          
              </div>         
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_59->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>              
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_60->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>            
              </div>
            </div>            
        </div>
     ...
     <div style="width: 180px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default" style="margin-top: 130px;">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_158->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>           
            <div class="panel panel-default" style="margin-top: 87px;">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_61->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>          
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_62->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_63->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_64->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>       
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_65->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_66->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>              
              </div>
            </div>            
        </div>
     ...
     <div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default" style="margin-top: 130px;">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_159->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>           
            <div class="panel panel-default" style="margin-top: 87px;">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_67->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>         
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_68->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_69->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_70->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>         
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_71->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_72->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>            
        </div>
     ...
     <div style="width: 180px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default" style="margin-top: 210px;">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_73->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>                
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_74->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>              
              </div>         
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_76->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_77->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>        
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_79->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>            
        </div>
     ...
     <div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default"  style="margin-top: 210px;">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_80->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_81->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>        
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_82->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_83->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_84->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>        
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_85->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_86->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>            
        </div>
     ...
     <div style="width: 180px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default" style="margin-top: 210px;">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_87->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_88->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>        
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_89->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_90->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_91->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>        
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_92->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_93->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>            
        </div>
     ...
     <div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default"  style="margin-top: 210px;">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_94->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_95->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>        
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_96->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
            ...
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_98->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>        
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_99->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_100->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>            
        </div>
      ...
      <div style="width: 180px; margin-left: 0px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_101->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_102->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_103->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>        
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_104->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_105->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_106->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>       
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_107->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_108->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>            
        </div>
     ...
     <div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_109->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_110->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_111->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>        
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_112->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_113->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_114->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>       
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_115->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_116->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>            
        </div>
      ...
      <div style="width: 180px; margin-left: 0px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_117->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_118->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_119->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>        
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_120->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_121->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_122->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>         
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_123->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_124->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>            
        </div>
     ...
     <div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_125->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_126->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_127->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>       
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_128->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_129->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_130->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>        
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_131->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_132->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>            
        </div>
      ...
      <div style="width: 180px; margin-left: 0px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_133->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_134->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_135->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>         
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_136->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_137->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_138->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>        
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_139->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_140->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>            
        </div>
     ...
     <div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_141->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_142->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_143->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>       
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_144->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_145->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_146->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>       
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_147->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_148->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>            
        </div>
        ...
        <div style="width: 180px; margin-top: 75px; position: relative;" class="col-sm-1">
         <div class="panel-group">           
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_149->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_150->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>       
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_151->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_152->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_153->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>       
          </div>
          <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_154->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
             ...
             <div class="panel-footer" style="height: 38px;">
                 <center><a href="{{route('postData3DMap', [$anim_155->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>            
        </div>
