...
<div class="panel-group">
       <div style="width: 180px; margin-left: 0px; " class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default">
              <div class="panel-heading">1</div>
              <div class="panel-body">
                  <input type="text" name="" class="form-control" placeholder="Dede" readonly="true">
                  <input type="text" name="" class="form-control" placeholder="Dede" readonly="true">
              </div>
            </div>
            <div class="panel panel-default">
    ...
    <!-- Page 1 -->
    <!-- Page 2 -->
     <div style="width: 180px; margin-left: -30px; " class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default">
    ...
    <!-- Page 3  -->
     <div style="width: 180px; " class="col-sm-1">
         <div class="panel-group">
            <div class="panel panel-default">
 ...
 <!-- Page 13  -->
    ...
    <!-- Page 21 -->
        <div style="width: 180px; margin-top: 75px;" class="col-sm-1">
         <div class="panel-group">
