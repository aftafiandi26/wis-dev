...
<div class="row" style=" margin-bottom: 10px;">
        <div class="col-sm-12">
          <a href="{{route('loadHTMLLayout')}}" class="btn btn-sm btn-warning" target="_blank">PDF</a> 
          <a href="{{route('excellLayout')}}" class="btn btn-sm btn-default">Excel</a>             
        </div>
</div>
             ...
             <div class="panel panel-default">
                  ...
                  <div class="panel-body" style="height: 131px">
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_237->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
             </div>
          </div>
             ...
             <div class="panel-group">
                <div class="panel panel-default">
                  <div class="panel-heading">238</div>
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_238->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                 <div class="panel panel-default">
                  ...
                  <div class="panel-body" style="height: 131px">
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_239->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                 <div class="panel panel-default">
                  ...
                  <div class="panel-body" style="height: 131px">
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_240->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                 <div class="panel panel-default">
                  ...
                  <div class="panel-body" style="height: 131px">
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_241->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
            </div>
             ...
             <div class="panel-group">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body" style="height: 131px">
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_242->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                 <div class="panel panel-default">
                  ...
                  <div class="panel-body" style="height: 131px">
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_243->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                 <div class="panel panel-default">
                  ...
                  <div class="panel-body" style="height: 131px">
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_244->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                 <div class="panel panel-default">
                  ...
                  <div class="panel-body" style="height: 131px">
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_245->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
            </div>
             ...
             <div class="panel-group">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body" style="height: 131px">
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_246->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                 <div class="panel panel-default">
                  <div class="panel-heading">247</div>
                    <div class="panel-body" style="height: 131px">
                     ...
                     <div class="panel-footer" style="height: 38px;">
                      <center><a href="{{route('postDataLayout', [$layout_247->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                      </center>
                    </div>
                  </div>
                 ...
                 <div class="panel panel-default">
                  <div class="panel-heading">248</div>
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_248->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                 <div class="panel panel-default">
                  <div class="panel-heading">249</div>
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_249->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
            </div>
             ...
             <div class="panel-group">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body" style="height: 131px">
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_250->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                 <div class="panel panel-default">
                  ...
                  <div class="panel-body" style="height: 131px">
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_251->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                 <div class="panel panel-default">
                  ...
                  <div class="panel-body" style="height: 131px">
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_252->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                 <div class="panel panel-default">
                  ...
                  <div class="panel-body" style="height: 131px">
                   ...
                   <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataLayout', [$layout_253->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
            </div>
         ...
         <div class="panel-group">
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_160->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>              
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">161</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_161->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>  
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_162->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>           
          </div>
          <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_163->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div> 
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">164</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_164->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div> 
            </div>                       
        </div>
         ...
         <div class="panel-group">
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_165->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div> 
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">166</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_166->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div> 
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_167->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>          
          </div>
          <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_168->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">169</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_169->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>                       
        </div>
         ...
         <div class="panel-group">
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_170->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">171</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_171->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">172</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_172->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>           
          </div>
          <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_173->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div> 
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_174->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div> 
            </div>                       
        </div>
         ...
         <div class="panel-group">
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_175->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div> 
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">176</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_176->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div> 
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">177</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_177->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>            
          </div>
          <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_178->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_179->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>                       
        </div>
         ...
         <div class="panel-group">
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_180->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">181</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_181->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_182->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>           
          </div>
          <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_183->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div> 
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">184</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_184->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>                       
        </div>
         ...
         <div class="panel-group">
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_185->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">186</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_186->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">187</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_187->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>           
          </div>
          <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_188->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_189->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">190</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_190->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>                       
        </div>
         ...
         <div class="panel-group">
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_191->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">192</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_192->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">193</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_193->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>        
          </div>
          <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_194->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_195->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_196->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>                       
        </div>
         ...
         <div class="panel-group">
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_197->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_198->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">199</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_199->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>           
          </div>
          <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_200->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_201->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_202->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>                       
        </div>
         ...
         <div class="panel-group">
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_203->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_204->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_205->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>          
          </div>
          <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_206->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_207->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_208->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>                       
        </div>
         ...
         <div class="panel-group">
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_209->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_210->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_211->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>          
          </div>
          <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_212->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_213->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_214->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>                       
        </div>
         ...
         <div class="panel-group">
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_215->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_216->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_217->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>          
          </div>
          <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_218->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_219->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_220->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>                       
        </div>
         ...
         <div class="panel-group">
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_221->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_222->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_223->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>          
          </div>
          <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_224->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_225->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_226->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>                       
        </div>
         ...
         <div class="panel-group">
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_227->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_228->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_229->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>           
          </div>
          <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_230->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_231->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_232->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>                       
        </div>
          ...
          <div class="row">
             <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_233->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
              <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_234->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
          ...
          <div class="row">
             <div class="panel panel-default">
              <div class="panel-heading">235</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_235->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
              <div class="panel panel-default">
              <div class="panel-heading">236</div>
               ...
               <div class="panel-footer" style="height: 38px;">
                <center><a href="{{route('postDataLayout', [$layout_236->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                </center>
              </div>
            </div>
