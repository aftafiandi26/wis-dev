...
<div class="row" style=" margin-bottom: 10px;">
  <div class="col-sm-12">
    <a href="{{route('loadHTMLRender')}}" class="btn btn-warning" target="_blank">PDF</a>   
              ...
              <div style="width: 180px; margin-left: 0px; position: relative;" class="col-sm-1">
                <div class="panel-group">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_254->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                <div class="panel panel-default">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_258->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                <div class="panel panel-default" style="margin-top: 33px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_262->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                <div class="panel panel-default">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_266->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                <div class="panel panel-default" style="margin-top: 33px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_270->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                <div class="panel panel-default">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_274->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                <div class="panel panel-default" style="margin-top: 33px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_278->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
              </div>
            ...
            <div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
              <div class="panel-group">
                <div class="panel panel-default">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_255->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                <div class="panel panel-default">
                ...
                <div class="panel panel-default" style="margin-top: 33px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_263->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                <div class="panel panel-default">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_267->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                <div class="panel panel-default" style="margin-top: 33px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_271->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                <div class="panel panel-default">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_275->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
                <div class="panel panel-default" style="margin-top: 33px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_279->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
                </div>
              </div>
              ...
              <div class="panel-group">
               <div class="panel panel-default">
                <div class="panel-heading">256</div>
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_256->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
              </div>
              <div class="panel panel-default">
                ...
                <div class="panel-body" style="height: 131px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_260->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
              </div>
              <div class="panel panel-default" style="margin-top: 33px">
                ...
                <div class="panel-body" style="height: 131px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_264->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
              </div>
              <div class="panel panel-default">
                ...
                <div class="panel-body" style="height: 131px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_268->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
              </div>
              <div class="panel panel-default" style="margin-top: 33px">
                ...
                <div class="panel-body" style="height: 131px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_272->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
              </div>
              <div class="panel panel-default">
                ...
                <div class="panel-body" style="height: 131px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_276->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
              </div>
            </div>
             ...
             <div class="panel panel-default">
              <div class="panel-heading">257</div>
               <div class="panel-body" style="height: 131px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_257->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_261->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
            </div>
            <div class="panel panel-default" style="margin-top: 33px">
              ...
              <div class="panel-body" style="height: 131px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_265->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_269->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
            </div>
            <div class="panel panel-default" style="margin-top: 33px">
              ...
              <div class="panel-body" style="height: 131px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_273->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
            </div>
            <div class="panel panel-default">
              ...
              <div class="panel-body" style="height: 131px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_277->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
            </div>
          </div>
        ...
        <div class="panel-group">
          <div class="panel panel-default">
            <div class="panel-heading">347</div>
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_347->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_350->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_359->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_362->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_365->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_368->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_371->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_374->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_377->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
        </div>
      </div>
        <div style="width: 180px; margin-left: 0px; margin-top: -15px; position: relative;" class="col-sm-1">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_348->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_351->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_354->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_357->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_360->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_363->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_366->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_369->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_372->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
          <div class="panel panel-default">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body" style="height: 63px;">                        
              ...
              <div class="panel-footer" style="height: 38px;">
                  <center><a href="{{route('postDatarender', [$Render_378->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a></center>
               </div>
          </div>
        </div>
      </div>
        ...
        <div style="width: 180px; margin-left: 240px; position: relative;" class="col-sm-1">
          <div class="panel panel-default" style="margin-top: 1325px;">
            ...
            <div class="panel-body" style="height: 131px">
                 ...
                 <div class="panel-footer" style="height: 38px;">
                    <center><a href="{{route('postDataRender', [$Render_343->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
                    </center>
                  </div>
          </div>
        </div>
  ...
  <div style="width: 180px; margin-left: 0px; position: relative;" class="col-sm-1">
    <div class="well well-lg" style="margin-top: 60px; height: 630px; width: 370px;">
      <div style="width: 180px; margin-left: 0px; position: relative;" class="col-sm-1">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_344->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
        </div>
      </div>
    ...
    <div class="well well-lg" style="height: 630px; width: 370px;">
      <div style="width: 180px; margin-left: 0px; position: relative;" class="col-sm-1">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_345->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
          </div>
          <div class="panel panel-default">
            ...
            <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_346->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
            </div>         
          </div>
        </div>                      
 ...
 <div style="width: 180px; margin-left: 220px; position: relative;" class="col-sm-1">
    <div class="panel-group" style="margin-top: 60px;">
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_280->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_281->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_282->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_283->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_284->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_285->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
    </div>
  ...
  <div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
    <div class="panel-group" style="margin-top: 60px;">
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_286->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_287->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_288->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_289->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_290->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_291->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
    </div>
  ...
  <div style="width: 180px; margin-left: 0px; position: relative;" class="col-sm-1">
    <div class="panel-group" style="margin-top: 60px;">
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_292->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_293->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_294->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_295->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_296->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_297->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
    </div>
  ...
  <div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
    <div class="panel-group" style="margin-top: 60px;">
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_298->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_299->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_300->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_301->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_302->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_303->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
    </div>
  ...
  <div style="width: 180px; margin-left: 0px; position: relative;" class="col-sm-1">
    <div class="panel-group" style="margin-top: 60px;">
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_304->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_305->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_306->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_307->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_308->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_309->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
    </div>
  ...
  <div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
    <div class="panel-group" style="margin-top: 60px;">
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_310->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_311->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_312->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_313->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_314->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_315->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
    </div>
  ...
  <div style="width: 180px; margin-left: 0px; position: relative;" class="col-sm-1">
    <div class="panel-group" style="margin-top: 60px;">
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_316->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_317->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_318->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_319->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_320->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_321->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
    </div>    
...
<div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
    <div class="panel-group" style="margin-top: 60px;">
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_322->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_323->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_324->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_325->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_326->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_327->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
    </div>    
...
<div style="width: 180px; margin-left: 0px; position: relative;" class="col-sm-1">
    <div class="panel-group" style="margin-top: 900px;">
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_328->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_329->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_330->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
    </div>    
...
<div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
    <div class="panel-group" style="margin-top: 900px;">
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_331->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_332->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_333->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
    </div>    
...
<div style="width: 180px; margin-left: 0px; position: relative;" class="col-sm-1">
    <div class="panel-group" style="margin-top: 900px;">
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_334->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_335->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_336->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
    </div>    
...
<div style="width: 180px; margin-left: -30px; position: relative;" class="col-sm-1">
    <div class="panel-group" style="margin-top: 900px;">
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_337->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_338->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_339->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
    </div>    
...
<div style="width: 180px; margin-left: 0px; position: relative;" class="col-sm-1">
    <div class="panel-group" style="margin-top: 900px;">
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_340->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_341->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
      <div class="panel panel-default">
        ...
        <div class="panel-footer" style="height: 38px;">
            <center><a href="{{route('postDataRender', [$Render_342->id])}}" class="btn btn-sm btn-danger" style="color: black; margin-top: -5px; color: white;">Edit</a>
            </center>
        </div>
      </div>
    </div>    
