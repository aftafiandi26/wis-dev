...
<div class="row">
     <div align="right" class="col-lg-12">
        <a style="margin-bottom: 15px;" class="btn btn-sm btn-info" data-original-title="Add" data-toggle="tooltip" data-placement="top" href="{{ route('addAsset1') }}"><span class="fa fa-plus"></span> Hardware</a>
         <a style="margin-bottom: 15px;" class="btn btn-sm btn-danger" data-original-title="Add" data-toggle="tooltip" data-placement="top" href="{{ route('addAsset1') }}"><span class="fa fa-plus"></span> Software</a>
    </div>
</div>
