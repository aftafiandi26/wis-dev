...
class Leave_Transaction_Employes_Coordinator_Controller extends Controller
{
    public function __construct()
    {
        $this->middleware(['auth', 'active', 'production', 'koor']);
    }
    ...
    public function indexEmployes()
    {
        ...
        return view('all_employee.leave.employes.productions.coordiantor.index', compact(['header']));
    }

    public function dataEmployesCoordinator()
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('actions', function (Leave $leave) {
                return view('all_employee.leave.employes.productions.coordiantor.actions', compact('leave'));
            })
            ->rawColumns(['actions'])
    ...
    public function detail($id)
    {
        ...
        return view('all_employee.leave.employes.productions.coordiantor.actions.detail', compact(['leave', 'foreachStatment']));
    }
    ...
    public function generePDF($id)
    {
        ...
        $pdf = PDF::loadview('all_employee.leave.employes.productions.coordiantor.actions.download', compact(['leave', 'header', 'foreachStatment']));
    ...
    public function reminderMail($id)
    {
        ...
        return view('all_employee.leave.employes.productions.coordiantor.actions.reminder', compact(['leave', 'foreachStatment', 'send', 'id']));
    }
    ...
    {
        return view('all_employee.leave.employes.productions.coordiantor.actions.delete', compact(['id']));
    }
