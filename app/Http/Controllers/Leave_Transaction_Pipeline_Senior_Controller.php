...
class Leave_Transaction_Pipeline_Senior_Controller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('all_employee.leave.employes.productions.pipeline.senior.index', compact(['header']));
    }

    public function datatables()
    {
        $query = Leave::where('user_id', auth()->user()->id)->latest()->get();
        ...
        return Datatables::of($query)
            ...
            ->addColumn('actions', function (Leave $leave) {
                return view('all_employee.leave.employes.productions.pipeline.senior.actions', compact('leave'));
            })
            ->rawColumns(['actions'])
    ...
    public function detail($id)
    {
        ...
        return view('all_employee.leave.employes.productions.pipeline.senior.actions.detail', compact(['leave', 'foreachStatment']));
    }
    ...
    public function generePDF($id)
    {
        ...
        $pdf = PDF::loadview('all_employee.leave.employes.productions.pipeline.senior.actions.download', compact(['leave', 'header', 'foreachStatment']));
    ...
    public function reminderMail($id)
    {
        ...
        return view('all_employee.leave.employes.productions.pipeline.senior.actions.reminder', compact(['leave', 'status', 'id']));
    }
